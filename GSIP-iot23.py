...
print(
    f"Sampling {SAMPLE_FRAC * 100:.1f}% "
    f"for ALL other classes ..."
)
...
print(
    "Label counts after manual-minority keep & uniform sampling:"
)
...
try:
    ...
    if len(hidden_np) > 10:
        ...
        if len(hidden_np) > 10:
            ...
            ax_tsne.set_title(
                'GSIP IoT23 Test Hidden Embeddings'
            )
